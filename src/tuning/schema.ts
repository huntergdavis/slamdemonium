...
const definitions = [
  ...
  },
  {
    ...
    max: 20.0,
    step: 0.5,
    help: 'Speed added along the heading the moment you drive onto an accelerator triangle. An impulse, not a top-speed lift: worth a small detour, not so large it removes the choice.',
  },
  {
    key: 'padBoost',
    group: 'Boost & Drift',
    ...
    max: 1.0,
    step: 0.01,
    help: 'How much of the boost bar one accelerator triangle grants. Tiny by design: the kick is the pad, the charge is incidental (twenty pads to a bar).',
  },
  {
    key: 'boostDrainRate',
    group: 'Boost & Drift',
  ...
  },
  {
    ...
    max: 2.0,
    step: 0.01,
    help: 'Meter earned per second of a reference drift (30 deg at 40 m/s). Very slow by design: boost is earned by danger, and the fast earners (traffic, wrong side, crashes) do not exist yet.',
  },
  {
    key: 'airChargeRate',
    group: 'Boost & Drift',
    ...
    max: 1.0,
    step: 0.01,
    help: 'Meter earned per second airborne, once the kerb-hop gate calls it flight. A giant-ramp jump is about a second and a half in the air.',
  },
  {
    key: 'driftMinAngle',
    group: 'Boost & Drift',
  ...
  },
  {
    ...
    step: 1.0,
    quick: true,
    help: 'Extra FOV at top speed. Positive widens the lens for peripheral motion and pushes the car visually further away; negative narrows it for a tighter, closer look.',
  },
  {
    key: 'camSpeedPull',
    group: 'Camera',
    label: 'Cam speed pull',
    unit: 'x',
    default: 1.0,
    min: 0.0,
    max: 1.0,
    step: 0.05,
    help: 'How much of the speed lag the chase camera cancels. At 0 the camera falls back v x follow time behind the car (22 m at top speed, measured); at 1 it holds its rest distance at any speed, with the same spring on transients. Never applies while reversing.',
  },
  {
    key: 'camSpeedClose',
    group: 'Camera',
    label: 'Cam speed close',
    unit: 'm',
    default: 1.5,
    min: 0.0,
    max: 4.0,
    step: 0.1,
    help: 'How much closer than its rest distance the chase camera sits at top speed, scaling with speed. The faster you go, the closer it gets.',
  },
  {
    key: 'fovBoostKick',
    group: 'Camera',
