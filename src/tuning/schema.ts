...
const definitions = [
  ...
  },
  {
    ...
    max: 1.0,
    step: 0.05,
    help: 'How much of the boost bar one accelerator triangle grants. Three pads fill it from empty at the default.',
  },
  {
    key: 'boostDrainRate',
    group: 'Boost & Drift',
  ...
  },
  {
    ...
    max: 2.0,
    step: 0.05,
    help: 'Meter earned per second of a reference drift (30 deg at 40 m/s). Much slower than it was (0.35), so the accelerator pads are the main way to earn boost.',
  },
  {
    key: 'driftMinAngle',
    group: 'Boost & Drift',
