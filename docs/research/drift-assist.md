...
Numerical spot-check performed: mirrored signs, restoring-limit direction, exact
zero-assist torque, and 0°/20°/55° exit/neutral/full targets passed. An isolated
angular model starting at 30°, targeting 20° with zero initial angular rate and
Default assist, ended within 0.00004° of target after five seconds at each of
60/120/240 Hz. This excludes tires, path dynamics and state transitions; the real
vehicle and human tests above are still required.
